...
CREATE OR REPLACE FUNCTION
  yb_pg_enable_tracing(pid int4 DEFAULT NULL, query_id int8 DEFAULT NULL, trace_verbosity int4 DEFAULT 0)
RETURNS boolean
LANGUAGE INTERNAL
...
CREATE OR REPLACE FUNCTION
  is_yb_pg_tracing_enabled(pid int4 DEFAULT NULL, query_id int8 DEFAULT NULL, trace_verbosity int4 DEFAULT 0)
RETURNS boolean
LANGUAGE INTERNAL
STABLE PARALLEL SAFE
