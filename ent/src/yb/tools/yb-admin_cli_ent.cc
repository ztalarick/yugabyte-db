  ...
  Register(
      ...
      [client](const CLIArguments& args) -> Status {
        ...
        if (args.size() > 2) {
          ...
          if (uppercase_record_type != yb::ToString("KEY_ONLY") &&
              uppercase_record_type != yb::ToString("FULL_ROW_OLD_AND_NEW_IMAGES") &&
              uppercase_record_type != yb::ToString("FULL_ROW_OLD_IMAGE") &&
              ...
              uppercase_record_type != yb::ToString("MODIFIED_COLUMN_OLD_IMAGE") &&
              uppercase_record_type != yb::ToString("MODIFIED_COLUMNS_NEW_IMAGE") &&
